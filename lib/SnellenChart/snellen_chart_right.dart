...
class SnellenChartRight extends StatefulWidget {
  final int feet;
  final String letterToDisplay;
  const SnellenChartRight({
    Key? key,
    required this.feet,
  ...
  @override
  State<SnellenChartRight> createState() => _SnellenChartRightState();
}

class _SnellenChartRightState extends State<SnellenChartRight> {
